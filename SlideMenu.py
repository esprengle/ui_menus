...
class SideMenuSlideView(ui.View):
    ...
    def touch_moved(self, touch):
        ...
        if touch.location[0] > self.touch_start[0]:
            ...
            slide_percent = self.detail.x / self.master.width
            self.master.alpha = slide_percent
        self.detail.width=self.width-self.detail.x
    def touch_ended(self, touch):
        ...
        def slide_right():
            ...
            self.detail.width=self.width-self.master.width
            self.master.alpha = 1
...
if __name__=='__main__':
	...
	detail.flex = 'WH'
	detail.scales_page_to_fit = True
	detail.border_color='red'
	detail.border_width=4
